function fnext(x)
    nx1 = 0.9 * (x[1] - 0.01 * x[2]);
    nx2 = 0.9 * (x[2] + 0.01 * x[1]);
    return [nx1, nx2]
end
...
XDIM = 2; XMIN = -10.0; XMAX = 10.0; XDEG = 2
...
postcond = x[1]^2 - 2 * x[2]^2 - 4
postcond = -(x[1]^2 + (x[2] - 2)^2 - 0.25) 
